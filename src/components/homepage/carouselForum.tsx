...
export default function ForumCarousel() {
  ...
  <div className="w-[60%] p-[5%] h-[40%] justify-self-center">
              ...
              <div className="p-6 w-[40%]" key={id}>   
                <div className="h-[220px] mx-[3%] bg-white rounded-[34px]">
                      ...
                      <div className="ms-[15%] me-[15%] pt-[5%]">   
                            <div className="flex">
                                <img src={"https://74gslzvj-8000.asse.devtunnels.ms" + item.fotoKonten} width={70} height={40} alt="foto konten" />
      ...
      <div className="flex -translate-y-40 -translate-x-24">
        <Image src={prevButton} onClick={previous} width={60} height={60} alt="prev" />
        <Image src={nextButton} className="ms-[120%]" onClick={next} width={60} height={60} alt="prev" />
         </div>
    </div>
  );
}
