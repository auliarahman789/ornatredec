...
function ForumBurung() {
  ...
  async function getForumBurung() {
    ...
    try {
      ...
      alert("Berhasil mengambil data konten forum burung.");
    } catch (error: any) {
      console.error(
        "Error fetching forum data:",
        error.response || error.message
      );
      alert("Terjadi kesalahan saat mengambil data konten forum burung.");
    }
  }
