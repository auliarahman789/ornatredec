...
function Trending() {
  ...
  async function getTrending() {
    ...
    try {
      ...
      console.log(error);
      alert(
        "Terjadi kesalahan saat mengambil data konten yang sedang populer."
      );
    }
  }
  return (
    <div className="flex">
      <div className="flex ml-[4%]">
        ...
        <div className="flex-col space-y-3 w-[100%]">
          {data.length > 0 ? (
            data.map((item: any, id: number) => (
              <div
                key={id}
                className=" h-[90px] w-[260px]  rounded-lg pe-5 bg-white shadow-[3px_4px_4px,-3px_6px_4px] shadow-[#0000002d]"
              >
                <div className="flex">
                  ...
                  <div className="ms-[5%] flex-col space-y-1">
                    <div className="flex space-x-2 mt-[3%] mb-[2%]">
                      <p className="text-[11px] text-[#21B892] mt-1">
                        {item.User.username}
                      </p>
                    </div>
        ...
        <div className="mt-[4.5%] flex-col space-y-11 ms-[23%]">
          ...
          <p className="text-white text-[40px] font-semibold text-center">4</p>
        </div>
      </div>
    </div>
  );
