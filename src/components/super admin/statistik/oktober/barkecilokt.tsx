    ...
    useEffect(() => {
      ...
      async function getBarKecil() {
        ...
        try {
          ...
          const formattedData = [
            { name: "Tanaman", pv: res.data.totalProdukTanaman },
            { name: "Ikan", pv: res.data.totalProdukIkan },
            { name: "Burung", pv: res.data.totalProdukBurung},
          ];
