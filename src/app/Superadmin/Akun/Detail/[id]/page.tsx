            ...
            <>
              <div className="flex ms-[8%] space-x-7">
                ...
                <div className="flex-col -translate-y-2">
                  ...
                  <p className="text-[15px] ms-1 font-light">
                    {data.user.email}
                  </p>
                  <p className="text-[15px] ms-1 font-light">
                    {data.user.no_hp}
                  ...
                  <div className="flex">
                    ...
                    <p className="text-[15px] font-medium me-[26%] translate-y-[3px] whitespace-nowrap">
                      {data.user.alamats && data.user.alamats.length > 0
                        ? data.user.alamats[0].kota_kabupaten
                        : "Tidak tersedia"}
                    </p>
                    <button
                      id="hubungi"
                      onClick={handleEmailClick}
                      className="w-[100px] text-white px-3 py-[2px] rounded-lg bg-[#3F9272]"
                    >
                      Hubungi
                    </button>
                  </div>
              ...
              <div className="flex-col mt-[4%] ">
                <p className="text-[13px] ms-[4%]">
                  Ulasan{" "}
                  <span className="text-[#3F9272]">{data.user.username}</span>
                </p>
                <div className="flex space-x-[10%]">
                  <div className="bg-white ms-[2%] min-h-screen mb-10 py-6 mt-2 w-[53%] flex flex-col space-y-5">
                    {data.Postingan.map((item: any) => (
                      <div
                        key={item.id}
                        className="w-[90%] h-[190px]  mx-auto shadow-[3px_4px_4px,-3px_6px_4px] shadow-[#0000002d]"
                      >
                        {item.jumlahReport > 0 ? (
                          <div className="relative">
                            <Image
                              ...
                              height={20}
                            />
                            <p className="absolute top-8 right-[14px]">
                              {item.jumlahReport}
                            </p>
                          </div>
                        ) : (
                    ...
                    <div className="bg-[#1AE5CC] h-[190px] flex-col rounded-xl">
                      <div className="flex justify-center pt-[22%]">
                        ...
                        <p className="font-medium mt-2 text-[48px] text-white">
                          {data.Transaksiuser ? data.Transaksiuser : 0}
                        </p>
                      </div>
                      <p className="text-white text-[20px] ms-[30%]">
                        Berbelanja
                      </p>
                    </div>
                    <div className="bg-[#1AE5CC] h-[190px] flex-col rounded-xl">
