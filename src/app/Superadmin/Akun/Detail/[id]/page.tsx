                ...
                <div className='bg-[#E4FFF2] min-h-screen w-[70%] ms-[5%] p-4 rounded-md mt-[3%]'>
                    ...
                    {data && (
                        <div className="flex ms-[8%] space-x-7">
                            <img
                                src={data.photoProfile ? "https://74gslzvj-8000.asse.devtunnels.ms" + data.photoProfile : "/img/default-avatar.png"} 
                                width={130} height={130} alt='foto profil' className='rounded-full' 
                            />
                            <div className="flex-col -translate-y-2">
                                <p className='text-[34px] ms-1 translate-y-4 mb-1'>{data.username}</p>
                                ...
                                <div className="flex">
                                    ...
                                    <p className='text-[15px] font-medium me-[26%] translate-y-[3px]'>{data.alamats && data.alamats.length > 0 ? data.alamats[0].kota_kabupaten : 'Tidak tersedia'}</p>
                    ...
                    <div className="flex-col mt-[4%] ">
                        <p className="text-[13px] ms-[4%]">Ulasan <span className='text-[#3F9272]'>Belia</span></p>
                                ...
                                <div className="w-[90%] h-[190px]  mx-auto shadow-[3px_4px_4px,-3px_6px_4px] shadow-[#0000002d]">
                                    <div className="flex">
                                        <div className="flex-col">
                                            <Image src={contoh} width={180} height={180} alt='foto profil' />
                                        ...
                                        <div className='m-[5%] flex-col space-y-1'>
                                            <div className="flex space-x-2">
                                                <Image src={contoh} width={30} height={30} alt='foto profil' className='rounded-full' />
                                                <p className="text-[15px] text-[#21B892] mt-1">Beliaaa</p>
                                            </div>
                                            <p className="font-medium text-[18px] leading-none text-[#323735]">
                                                Bunga matahari sangat cantikk
                                            </p>
                                            <p className="font-light text-[12px]">
                                                Ulasan dari <span className="text-[#005DE8]">Beliaa</span> pada 20-09-2028
                                            </p>
                                            <button className="bg-[#C2FFE8] p-[2px] rounded w-[35%] text-[#06612B] font-light text-[12px]">Tanaman</button>
                                            <div className="flex pt-[7%] translate-x-[50%]">
                                                <Image src={seen} width={20} height={20} alt='foto profil' />
                                                <p className="ms-1 font-light mt-1 text-[12px] text-[#323735]">500</p>
                                                <Image src={reply} className='ms-3' width={20} height={20} alt='foto profil' />
                                                <p className="font-light ms-1 mt-1 text-[12px] text-[#323735]">500</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex-col mt-[5%] space-y-7 w-[25%]">
                                <div className="bg-[#1AE5CC] h-[190px] flex-col rounded-xl">
                                    <div className="flex justify-center pt-[22%]">
                                        <Image src={pesan} width={47} height={47} alt='foto profil' />
                                        <p className="font-medium mt-2 text-[48px] text-white">30</p>
                                    </div>
