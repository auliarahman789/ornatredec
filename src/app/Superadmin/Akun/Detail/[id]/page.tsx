                    ...
                    {data && (
                        <><div className="flex ms-[8%] space-x-7">
                            ...
                            <div className='flex-col space-y-3 pl-[15%]'>
                                ...
                                <p className='text-[15px] ms-1 mt-1 font-light'>{data.user.createdAt}</p>
                            </div>
                        </div>
                            <div className="flex-col mt-[4%] ">
                                ...
                                <div className="flex space-x-[10%]">
                                    ...
                                    {data && data.user && Array.isArray(data.user.posts) && data.user.posts.length > 0 ? (
    data.user.posts.map((item: any) => (
                                            <div key={item.id} className="w-[90%] h-[190px]  mx-auto shadow-[3px_4px_4px,-3px_6px_4px] shadow-[#0000002d]">
                                                <div className="flex">
                                                    <div className="flex-col">
                                                        <Image src={data.posts.fotoKonten ? "https://74gslzvj-8000.asse.devtunnels.ms" + data.posts.fotoKonten : "/img/default-avatar.png"} width={180} height={180} alt='foto konten' />
