...
import Tanamanproduk from "@/components/super admin/tanamanproduk";
      ...
      <div className="translate-x-64 pt-[2%]">
        <div className="flex">
          ...
          <div className="mt-5 ms-[5%] space-x-3">
            <button
              ...
              className={`text-sm px-3 pt-1 text-[#308967] rounded-full ${
                activeProduk === "Tanaman Hias"
                  ? "bg-gradient-to-b from-[#0D6734] to-[#247E55] text-white"
                  : ""
              }`}
            >
              Tanaman Hias
        ...
        <div className="mt-[2%] bg-[#E4FFF2] pb-[3%] min-h-screen w-[73%] rounded-md relative translate-x-10">
          <Link href="/Superadmin/Produk/tambah">
            <button className="text-sm px-3 pt-1 absolute right-4 top-4 flex text-[#308967] rounded-full">
              <Image
                src={tambah}
                className="me-2"
                width={16}
