          ...
          <div className='flex flex-col mt-[2%]'>
                  ...
                  <div className="flex relative space-x-[40%] mt-[4%] ms-[7%]">
                      <div className='absolute right-[30%] flex-col'>
                          ...
                          {selectAll === true ? 
                          <button className='bg-[#3F9272] translate-x-28 w-20 text-sm font-light pt-[0.5px] text-white  rounded-md'>Konfirmasi</button>
                          : ''}
                      </div>
                    </div>
                  ...
                  {data.length > 0 ? (
                            data.map((item: any) => (
                                <div key={item.id} className='flex space-x-[5%]'>
                                    <input type="checkbox" checked={selectAll} className='me-2' style={{ display: 'none' }} name='Konfirmasi' />
                                    ...
                                    <button className='bg-gradient-to-b h-6 rounded-full mt-[2%] pt-1 pb-2 px-3 from-[#308967] to-[#06612B] text-white text-[13px]  translate-y-[100%]' onClick={handleDetail}>Lihat</button>
                                    </Link>
                                </div>
                            ))
                        ) : (
