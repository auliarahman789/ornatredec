        ...
        <div className="flex">
          ...
          <div className="bg-[#E2FFF5] min-h-screen w-[62%] ms-[2.5%] pb-[8%]">
            <div className="flex flex-col mx-[10%] mt-[7%]">
              <label
                htmlFor="Nama produk"
                className="text-[#8EAEA6] text-[20px] font-semibold"
              >
                Nama Produk
              </label>
              <input
              ...
              <div className="flex w-full mt-[3%]">
                ...
                <div className="w-[50%] mt-6">
                  <label
                    htmlFor="foto"
                    className="text-[#8EAEA6] text-[25px] mt-[3%]"
                  >
                    Pilih Kategori
                  </label>
                  <div className="flex flex-col space-y-6 mt-[5%] ">
                    <div className="flex space-x-3">
                      ...
                      <label
                        htmlFor="tanaman"
                        className="text-[#308967] font-light"
                      >
                        Tanaman
                      </label>
                    </div>
              ...
              {/* <div className="relative">
                <button onClick={handleAdd}>
                  ...
                  <Image
                    ...
                    height={20}
                    alt="add"
                    className="absolute right-[100%] top-0 translate-y-8 me-2"
                  />
                </button>
              </div> */}
              {variasi.map((data, i) => (
