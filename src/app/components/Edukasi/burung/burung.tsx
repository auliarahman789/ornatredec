      ...
      >
        ...
        >
          <Image
            ...
            height={434}
          />
          <h1 className="content text-5xl text-white w-[543px] h-[450px]">
            Selengkapnya
          </h1>
        </div>
        <div
        ...
        >
          <Image
            ...
            height={434}
          />
          <h1 className="content text-5xl text-white translate-x-3 w-[530px] h-[449px]">
            Selengkapnya
          </h1>
        </div>
        <div
        ...
        >
          <Image
            ...
            height={434}
          />
          <h1 className="content text-5xl text-white ms-3 w-[527px] h-[450px]">
            Selengkapnya
          </h1>
        </div>
        <div
