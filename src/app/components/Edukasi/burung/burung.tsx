...
function Burung() {
  ...
  return (
    <div id="burung"><Burung2 isAnimated={isAnimated} setIsAnimated={setIsAnimated} /><div className="grid gap-0 overflow-x-hidden grid-cols-2 mx-[98px] me-[100px] pb-[8%]" >
       <div className={`${isAnimated ? 'transition-transform   ease-in-out translate-x-3 opacity-100' : '-translate-x-[100%] opacity-0'}`}>
      ...
      <div className={`transition-transform   ease-in-out overflow-x-hidden ${isAnimated ? 'translate-x-2 opacity-100' : 'translate-x-[100%] opacity-0'}`}>
        <Image src='/img/burung1.png' className="w-full h-auto -translate-x-[10px]" alt={"burung"} width={400} height={434} />
      </div>
      <div className={`${isAnimated ? 'transition-transform duration-1000 delay-300 ease-in-out translate-x-0 pe-1 opacity-100' : '-translate-x-[100%] opacity-0'}`}>
        <Image src='/img/burung2.png' className="w-full h-auto translate-x-[13px]" alt={"burung"} width={550} height={434} />
      </div>
      <div className={`transition-transform duration-1000 ease-in-out delay-300 overflow-x-hidden ${isAnimated ? 'translate-x-3 pe-7 ps-5 pt-5 opacity-100' : 'translate-x-[100%] opacity-0'}`}>
      ...
      <div className={`${isAnimated ? 'transition-transform duration-1000 delay-500 ease-in-out translate-x-3 opacity-100 pt-5' : '-translate-x-[100%] opacity-0'}`}>
      ...
      <div className={`transition-transform duration-1000 ease-in-out delay-500 overflow-x-hidden ${isAnimated ? 'translate-x-2 opacity-100' : 'translate-x-[100%] opacity-0'}`}>
        <Image src='/img/pakanburung.png' className="w-full h-auto -translate-x-[13px]" alt={"burung"} width={550} height={434} />
      </div>
      <div className={`${isAnimated ? 'transition-transform duration-1000 delay-700 ease-in-out translate-x-0 pe-1 opacity-100' : '-translate-x-[100%] opacity-0'}`}>
        <Image src='/img/burungmati.png' className="w-full h-auto translate-x-[13px]" alt={"burung"} width={550} height={434} />
      </div>
      <div className={`transition-transform duration-1000 ease-in-out delay-700 overflow-x-hidden ${isAnimated ? 'translate-x-3 pe-7 ps-5 pt-5 opacity-100' : 'translate-x-[100%] opacity-0'}`}>
