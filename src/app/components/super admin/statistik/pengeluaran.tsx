...
function Pengeluaran() {
  return (
      <div className='bg-[#E4FFF2] w-full min-h-screen rounded-xl px-5 pt-5 pb-8'>
          ...
          <div className="bg-white mt-[6%] py-2 rounded-xl ms-[4%] w-[40%] h-[180px]">
              <p className="text-[10px] ms-[3%]">
              pengeluaran di bulan <span className="text-[#28AFF8]">April 2024</span>
              </p>
          ...
          <div className="flex space-x-[40%] mx-8 mt-[4%]">
              ...
              <div className="flex-col">
                ...
                <li className="text-[20px]">
                  ...
                  <p className="font-bold text-[20px] mt-[18%]">
                  2100000
              </p>
              </div>
          </div>
