      ...
      <div>
              ...
              <div className='grid grid-cols-3 ms-20 space-y-10 pb-10'>
                  ...
                  <h1 className='text-[#3F9272] font-bold text-[33px]'>
                      ...
                      <p className='text-justify pe-8 text-[#54A082]'>
                            Forum T-trana adalah ruang diskusi khusus untuk para pecinta tanaman, ikan, dan burung hias. Di sini, Anda dapat terhubung dengan komunitas yang memiliki minat yang sama, berbagi pengalaman, serta mendapatkan tips dan saran untuk merawat koleksi Anda.
              ...
              <div className='bg-[#51CB9F] px-28 h-[280px]'>
          <h1 className='text-center font-bold text-[25px] text-white py-6'>Informasi Website</h1>
          <p className='text-justify text-white'>Selamat Datang di T-Trana
            Temukan keindahan alam di rumah Anda dengan koleksi eksklusif tanaman, ikan, dan burung hias kami. Di T-Trana, kami menghadirkan aneka flora dan fauna yang tidak hanya mempercantik ruangan, tetapi juga menghadirkan ketenangan dan keseimbangan.
            🌿 Tanaman Hias: Koleksi tanaman terbaik untuk mempercantik sudut rumah Anda, mulai dari tanaman indoor yang mudah dirawat hingga tanaman langka yang eksotis.
            🐟 Ikan Hias: Hiasi akuarium Anda dengan berbagai pilihan ikan yang memukau. Kami menawarkan spesies ikan hias berwarna-warni yang sehat dan siap memperindah suasana.
            🐦 Burung Hias: Nikmati kicauan indah dan warna-warna cerah burung hias pilihan kami. Dari burung paruh bengkok hingga burung kecil eksotis, semua tersedia di T-Trana.</p>
              </div>
              <Footer/>
      </div>
    </div>
