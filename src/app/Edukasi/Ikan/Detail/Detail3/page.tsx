      ...
      <div className="pt-1" id="tumbuhan">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-[#000000] to-[#d9d9d970] ps-8 pt-[10%]">
            <h1 className="text-5xl font-bold text-white">Makanan Ikan Hias</h1>
            <p className="w-[56%] text-[27px] text-white mt-2">
              Dapatkan informasi terbaru dan praktis tentang makanan yang baik
              untuk ikan hias di sini, dan tingkatkan pengalaman Anda dalam
