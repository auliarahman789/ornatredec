  ...
  return (
      <div className='bg-[#E4FFF2]'>
          <div className="flex flex-col items-center justify-center space-y-16 pb-16">
              <div className="h-[400px] w-[85%] bg-cover bg-center" style={{ backgroundImage: "url('/img/burung1.png')" }}>
              ...
              <div className="bg-white w-[85%] h-[680px]">
                  <Image src='/img/burung1.png' className='w-full h-[300px] object-cover' alt='1' width={100} height={100} />  
                  <div className='mx-[8%] mt-[3%]'>
                    <h1 className='text-[35px] font-bold text-[#3F9272] leading-10'>Memilih media tanam:
                        Pilih media tanam yang sesuai dengan tanaman.</h1>
