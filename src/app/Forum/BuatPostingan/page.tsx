...
// };
// const Page: React.FC<PopupPost> = ({ isVisible, onClose }) => {
...
//               name="desc"
//               onChange={handleInputChange}
//               className="bg-white rounded-[5px] text-lg pt-[3%] placeholder:font-light ps-[8%] placeholder:text-[#51CB9F] placeholder:text-[32px] w-[100%] h-[75%]"
//             />
//           </div>
//         </div>
//         <div className="relative">
