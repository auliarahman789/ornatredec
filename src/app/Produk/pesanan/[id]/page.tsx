...
const DetailPesanan = () => {
  ...
  const { tambahProdukKeKeranjang } = useKeranjang(); // Ambil fungsi dari KeranjangContext
  ...
  // Fungsi untuk menambah produk ke keranjang dan navigasi ke halaman keranjang
  const tambahKeKeranjang = () => {
    if (produk) {
      tambahProdukKeKeranjang(produk); // Tambahkan produk ke keranjang melalui context
      router.push("/Produk/keranjang"); // Navigasi ke halaman keranjang
    }
  };
        ...
        <div className="grid grid-cols-2">
          ...
          <div>
            ...
            <div className="flex flex-row translate-y-[500%]">
              ...
              <button
                onClick={tambahKeKeranjang} // Panggil fungsi tambahKeKeranjang saat ikon keranjang diklik
